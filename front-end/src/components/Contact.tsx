  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "600px", height: "600px", background: "radial-gradient(circle, rgba(232,200,64,0.05) 0%, transparent 60%)" }}
      />

      <div className="relative max-w-[1300px] mx-auto w-full px-10 flex flex-col items-center gap-10">
        {/* Heading */}
        <motion.div
        ...
        >
          ...
          <h2
            className="font-display font-black uppercase leading-[0.88] mb-4"
          ...
          <p className="text-sm font-light text-white/45 max-w-[380px] mx-auto leading-relaxed">
            Acompanhe o trabalho do Bombeiro Oliveira e faça parte dessa mudança real para o
            Espírito Santo.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="w-full grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-px bg-white/[0.08]"
        >
          {SOCIALS.map((s) => (
            <a
              key={s.name}
            ...
            >
              ...
              <div
                className="w-9 h-9 rounded-full border flex items-center justify-center mb-2.5 transition-all duration-300"
                style={{ borderColor: "rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.7)" }}
              >
                {s.icon}
              </div>
              <div className="font-display font-bold text-[12px] uppercase tracking-[0.2em] text-[var(--white)]">
                {s.name}
              </div>
        ...
        >
          <p
            className="font-display font-bold uppercase tracking-[0.05em] text-white/30 mb-6 leading-tight"
